/*
    ...
    * Method named distance with parameter another of type Point, it needs to return the
    ...
    How to find the distance between two points?To find a distance between points A(xA,yA)
    and B(xB,yB), we use the formula:
...
public class Point {
    ...
    public double distance(Point point){
        double distance = 0;
        distance = Math.sqrt((point.getX() - this.x) * (point.getX() - this.x) + (point.getY() -
