/*
    ...
    two complex numbers, just add or subtract the corresponding real and imaginary parts.
    ...
    imaginary of type double. It represents the Complex Number. The class needs to have one constructor. The
    constructor has parameters real and imaginary of type double and it needs to initialize the fields.
